		...
		try {
			...
			toast.success('Deployment successful!', {
				action: {
					...
					onClick: () =>
						window.open(
							getExplorerUrl(newRound.transactionHash),
							'_blank'
						),
				},
			});
		...
		try {
			...
			toast.success('Registration successful!', {
				action: {
					...
					onClick: () =>
						window.open(
							getExplorerUrl(signupResponse.transactionHash),
							'_blank'
						),
				},
			});
		...
		try {
			...
			toast.success('Vote successful!', {
				action: {
					...
					onClick: () =>
						window.open(
							getExplorerUrl(voteResponse.transactionHash),
							'_blank'
						),
				},
			});
				...
				<div className="mb-8 p-4 bg-gray-800 rounded border border-gray-700">
                    ...
                    ${maciKeypair.pubKey[1]}`
							...
							<p className="text-gray-200">
								...
								<span className="text-blue-400">
									{maciClient
										? `Created: ${maciClient.packMaciPubkey()}`
										: 'Not Created'}
								</span>
							</p>
							<p className="text-gray-200">
